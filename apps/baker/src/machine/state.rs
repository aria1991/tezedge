...
use tezos_messages::protocol::proto_012::operation::InlinedEndorsementContents;
...
pub struct EndorsementUnsignedOperation {
    ...
    pub content: InlinedEndorsementContents,
}
...
pub struct BlockData {
    ...
    pub preendorsement: Option<EndorsementUnsignedOperation>,
